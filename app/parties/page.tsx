			...
			<div className="flex-1 flex flex-col min-w-0">
				...
				<main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 overflow-y-auto pb-24">
					...
					<div className="space-y-4">
						{/* Header Row */}
						<div className="grid grid-cols-[auto_2fr_1.5fr_1.5fr_1.5fr_40px] gap-4 px-6 py-3 bg-[#1E1B4B]/5 rounded-xl border border-[#1E1B4B]/10 text-xs font-bold text-[#1E1B4B] uppercase tracking-wider items-center">
								...
								<AnimatePresence>
									{filteredParties.map((party, index) => (
										<motion.div
											...
											className={cn(
												"group grid grid-cols-[auto_2fr_1.5fr_1.5fr_1.5fr_40px] gap-4 p-5 bg-white rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-900/5 transition-all cursor-default items-center relative overflow-hidden",
										...
										>
											...
											{/* Address */}
											<div className="flex items-start gap-2 text-xs text-gray-500 group-hover:text-gray-700 transition-colors">
