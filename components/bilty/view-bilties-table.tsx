    ...
    <div className="space-y-6 max-w-[1600px] mx-auto pb-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          ...
          <Button variant="outline" onClick={handleExport} className="border-gray-200 text-gray-700 hover:bg-gray-50 hover:text-indigo-700 h-12 px-6 rounded-xl font-medium shadow-sm">
            <Download className="h-4 w-4 mr-2" />
            Export
          </Button>

          <Button onClick={() => window.location.href = '/bilty/create'} className="bg-[#1E1B4B] text-white hover:bg-[#2A275E] h-12 px-6 rounded-xl font-bold shadow-lg shadow-indigo-900/20 active:scale-95 transition-all">
      ...
      <div className="space-y-4">
        {/* Header */}
        <div className="grid grid-cols-[auto_1.5fr_2.5fr_1fr_auto] gap-4 px-6 py-3 bg-[#1E1B4B]/5 rounded-xl border border-[#1E1B4B]/10 text-xs font-bold text-[#1E1B4B] uppercase tracking-wider items-center">
            ...
            <AnimatePresence>
              {filteredBilties.map((bilty, index) => (
                <motion.div
                  ...
                  className={cn(
                    "group grid grid-cols-[auto_1.5fr_2.5fr_1fr_auto] gap-4 p-5 bg-white rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-900/5 transition-all cursor-default items-center relative overflow-hidden",
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-gray-900">{bilty.from}</span>
                        <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Origin</span>
                      </div>
                      <div className="flex-1 border-b-2 border-dashed border-gray-200 relative min-w-[3rem]">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-100 rounded-full p-1">
                          <ArrowRight className="h-3 w-3 text-gray-400" />
                        </div>
                      </div>
                      <div className="flex flex-col text-right">
                        <span className="text-sm font-bold text-gray-900">{bilty.to}</span>
                        <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Dest</span>
                      </div>
                    </div>
